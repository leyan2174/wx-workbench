...
- files: voice/image/download fixtures use publication guards, not the full
...
- windows_process / managed: managed execution is real, but account-capture Job
  construction and attachment are outside image/download host scope.
...
in image, emoticon and SNS download fixtures and shared support.
