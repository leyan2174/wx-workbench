...
#[allow(unfulfilled_lint_expectations)] // Message variants are public fixture API, unlike the production module.
pub mod messages;
...
#[allow(dead_code, unfulfilled_lint_expectations)] // Public slice fixtures may omit catalog evidence consumers; production expects remain active.
pub mod voice;
